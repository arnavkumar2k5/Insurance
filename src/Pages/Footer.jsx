...
function Footer() {
  return (
    <footer className="bg-[#343336] text-white py-10 pt-20 p-10">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between sm:justify-center gap-10 sm:gap-[35rem]">
        <div className="mb-10 sm:mb-0 sm:text-left">
          <div className="mb-4">
            <img src="logo2.png" alt="logo" className="h-16 md:h-24 sm:mx-0" />
          </div>
