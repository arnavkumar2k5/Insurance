...
function Component2() {
  return (
    <div className="bg-[#F5F5F5] pt-20 pb-20">
      <div className="w-[95%] md:w-[90%] m-auto flex flex-col gap-10 md:gap-28 p-3 md:p-10">
        <div className="flex flex-col-reverse md:flex-row justify-center gap-10 md:gap-24 items-center">
          <div className="w-full md:w-auto self-center">
            <img src="/Warehouse/img1.png" alt="family" className="h-[45vh] md:h-[76.5vh] pl-0 md:pl-20" />
          </div>
          <div className="w-full md:w-[43%] flex flex-col gap-16 text-[0.8rem] md:text-[0.9rem]">
            ...
            <div className="md:pr-4 flex flex-col gap-5 text-sm">
            <div>
