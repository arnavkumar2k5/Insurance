  ...
  return (
    <div className="bg-gradient-to-r from-[#0f6476] to-[#133e4e] flex flex-col md:flex-row items-center h-auto md:h-[40vh] justify-center px-5 md:px-10 gap-20">
      <div className="text-white md:text-left pt-10 md:pt-0">
        ...
        The raw materials, finished products, and merchandise you store in your warehouse are among your most valuable assets. Protect your business with a customized warehouse insurance policy from B-Insure.
        </p>
