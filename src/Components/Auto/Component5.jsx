...
function Component5() {
  return (
    <div className="bg-white">
      <div className=" m-auto flex flex-col p-5 md:p-40">
        <div className="flex flex-col md:flex-row justify-center gap-10  items-center">
          <div className="w-full md:w-[45%] flex flex-col gap-5 text-[0.8rem] md:text-sm">
            <div className="text-xl md:text-2xl font-semibold md:text-left">
            ...
            <div className="md:pr-4 flex flex-col gap-5">
              ...
              <ul className="list-disc pl-5">
                <li>
                  <b>Third-party liability: </b>Provides protection if you’re at
                  fault in an accident for injuring or killing someone or
                  damaging their property
                </li>

                <li>
                  <b>Direct compensation-property damage (DCPD):</b>DCPD covers
                ...
                <li>
                  <b>Accident benefits: .</b>If you are injured in an auto
                ...
                <li>
                  <b>Uninsured auto: </b>If you’re involved in an accident with an uninsured motorist or an unknown driver who commits a hit-and-run, your uninsured auto coverage will pay for damages to your vehicle.
                </li>
              </ul>
            </div>
          </div>
          <div className="w-full md:w-auto">
            <img
              src="/Auto/img9.png"
              alt="family"
              className="h-[40vh] md:h-[60vh] pl-0 md:pl-20"
            />
          </div>
        </div>
      </div>
