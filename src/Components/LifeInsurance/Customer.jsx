...
function Customer() {
  ...
  const carouselItems = testimonials.map((testimonial, index) => (
    <div className="shadow-2xl border-2 w-[80%] p-5 m-auto mt-5 pt-10 rounded-3xl text-start" key={index}>
  ...
  return (
    <div className="flex flex-col justify-center text-center bg-white pb-20 md:pb-40 pt-40">
