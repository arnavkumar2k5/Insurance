...
function Component5() {
  return (
    <div className="bg-white pt-40 pb-40 md:pl-40">
      <div className="m-auto flex flex-col p-5 md:p-10">
        <div className="flex flex-col md:flex-row justify-center items-center">
          <div className="w-full md:w-[60%] flex flex-col gap-2 md:gap-10 text-[0.8rem] md:text-[0.9rem]">
            <div className="text-xl md:text-3xl font-semibold md:text-left">
            How much CGL insurance coverage needed?
            </div>
            <div className="md:pr-4 flex flex-col gap-5 font-medium text-lg">
            <div>
            ...
            <div className="rounded-lg bg-[#24BBE3] text-white p-3 text-center md:w-[40%] self-center md:self-start">
            Insure your restaurant now!
            </div>
          </div>
          <div className="w-full md:w-auto mt-10 md:mt-0">
            <img src="/General/img7.png" alt="family" className="h-[50vh] md:h-[85vh]" />
          </div>
        </div>
      </div>
    </div>
