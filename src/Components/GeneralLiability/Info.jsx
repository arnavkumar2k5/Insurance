  ...
  return (
    <div className="flex flex-col gap-5 text-center p-3 sm:p-5 md:p-2 md:text-start pb-20">
      <div className="flex flex-col gap-2 md:gap-5">
        ...
        Commercial <span className="font-semibold">General Liability</span> {" "}
        <div className="inline md:block text-2xl sm:text-2xl md:text-4xl font-normal">
        Insurance
        </div>
        </div>
      </div>
      <div className="text-sm sm:text-base text-justify md:text-lg">
      Protect your small business from third-party injury and property 
      <p>damage claims with commercial general liability insurance.</p>
      </div>
