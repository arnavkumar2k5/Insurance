  ...
  return (
    <div className="flex flex-col gap-5 text-center p-5 sm:p-5 md:p-2 md:text-start pb-20">
      ...
      The last thing you want when travelling is to have a medical 
        <div>emergency. However, before you dive into your adventure,</div>
        <div>there's a crucial detail to address: securing your travel insurance.</div>
      </div>
